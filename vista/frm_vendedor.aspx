<%@ Page Title="" Language="C#" MasterPageFile="~/vista/Site.Master" AutoEventWireup="true" CodeBehind="frm_vendedor.aspx.cs" Inherits="Ejercicio.vista.frm_vendedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">    
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2 class="text-primary text-center">Vendedor</h2>
    <div class="container mb-3 mt-2 " >
            <asp:GridView ID="gvVendedor" runat="server" CellPadding="4"
                OnRowCommand="gvVendedor_RowCommand" CssClass="center"
